...
const {ipcMain} = require('electron')
  ipcMain.on('open-send-window', (event, arg) => {
    console.log("Received message from renderer") // prints "ping"
    mainWindow.loadURL(url.format({
  ...
  ipcMain.on('open-accepted-window', (event, arg) => {
    ...
    mainWindow.loadURL(url.format({
      pathname: path.join(__dirname, 'accepted.hbs'),
      protocol: 'file:',
      slashes: true
    }))
  })
